...
static unsigned int wait_input = 0;
...
const unsigned char gameover_mj1_alternate[7][42] = 
{
	"Zhongli seemed to be only midly",
	"satisfed...",
...
void Update_story()
{
	...
	Draw_Picture_8bpp(RES_YAMI_BIN_SA);
	switch(text_progress)
	{
						case 0:
							print_string(26, 1, "OH MY! What do we have here ?");
							print_string(27, 1, "You look so innocent...");
						break;	
						case 1:
							print_string(26, 1, "You're going to be the perfect victim");
							print_string(27, 1, "for my games!");
						break;	
						case 2:
							print_string(26, 1, "I am Rikuto, i offer you a chance to");
							print_string(27, 1, "prove your worth in a trial.");
						break;	
						case 3:
							print_string(26, 1, "Don't be scared, it will be fun!");
						break;	
						case 4:
							print_string(26, 1, "Your challenge will be this :");
							print_string(27, 1, "you will be on the other end and.");
							print_string(28, 1, "punish them.");
						break;
						case 5:
							print_string(26, 1, "Don't like it ? Your loss !");
						break;	
	}	
}
...
void switch_gamemode(unsigned char mode)
{
	...
	switch(mode)
	{
		/* Titlescreen */
		case 0:
			Draw_Picture_8bpp(RES_TITLE_BIN_SA);
			Upload_Palette(RES_TITLE_PAL_BIN_SA, RES_TITLE_PAL_BIN_EA);
		break;
		...
		case 1:
			...
			frame_picture = 0;
			status = 0;
			Upload_Palette(RES_FRAMES_PAL_BIN_SA, RES_FRAMES_PAL_BIN_EA);
			PPU_COLOR[0] = make_color(0, 0, 0);
			PPU_COLOR[1] = make_color(31, 31, 31);
		...
		case 2:
			if (global_score < 500)
			{
				Draw_Picture_8bpp(RES_BLACK_BIN_SA);
				for(i=0;i<10;i++)
				{
			...
			{
				Draw_Picture_8bpp(RES_YAMI_BIN_SA);
				Upload_Palette(RES_YAMI_PAL_BIN_SA, RES_YAMI_PAL_BIN_EA);
				print_string(25, 2, "Congrats ! I guess you are a");
				print_string(26, 2, "true Alpha male !");
				print_string(27, 2, "I'll think of a better challenge");
				print_string(28, 2, "later... For now, bye bye !");
			}
			PPU_COLOR[0] = make_color(0, 0, 0);
			PPU_COLOR[1] = make_color(31, 31, 31);
		break;
...
void picture()
{
	Draw_Picture_8bpp(RES_FRAMES_BIN_SA + ((76800L/2L) * frame_picture));
	
	/*switch(frame_picture)
	{
		case 0:
			Draw_Picture_8bpp(RES_FRAMES_BIN_SA);
		break;	
		case 1:
			Draw_Picture_8bpp(RES_FRAMES_BIN_SA + 76800/2);
		break;	
		case 2:
...
void ingame_fucking()
{
	...
	print_string(28, 9, "Your score :");
	print_dec(28, 23, global_score);
	...
	if (status_level1[status] != 4)
	{
		...
		if (frame_picture == 0 && Button_Pressed() && wait_input > 10)
		{
			frame_picture = 1;
		}
