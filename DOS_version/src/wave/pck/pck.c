...
static unsigned char PCK_Load(const char* WaveFile, unsigned char index)
{
	// Cancel out audio
	sample_prg = 1;
	sample_count = 0;
...
static void PCK_Play( unsigned char index)
{
...
static void PCK_Unload( unsigned char index)
{
