...
static unsigned char NULLWAV_Load(const char* WaveFile, unsigned char index)
{
	return 0;
}

static void NULLWAV_Play(unsigned char index)
{

}

static void NULLWAV_Unload(unsigned char index)
{
