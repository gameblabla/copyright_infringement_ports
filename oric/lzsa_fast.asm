	...
	; lzsa2_6502.s
	;
	; NMOS 6502 dec ompressor for data stored in Emmanuel Marty's LZSA2 format.
	;
...
cp_npages:     lda     #0                      ; Any full pages left to copy?
					...
					;
					; Copy bytes from dec ompressed window.
					;
					; N.B. X=0 is expected and guaranteed when we get here.
					;
					; xyz
