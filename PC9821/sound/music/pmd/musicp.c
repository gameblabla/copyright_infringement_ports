...
static void PMD_MusicStart(const unsigned char *mus_data, unsigned int music_data_size)
{
    ...
    memcpy((void *)linear_address, mus_data, music_data_size);
